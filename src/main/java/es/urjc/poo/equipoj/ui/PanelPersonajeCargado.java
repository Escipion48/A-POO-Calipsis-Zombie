...
import java.util.Arrays;
    ...
    public class PanelPersonajeCargado extends JPanel{
        final Juego juego;
        ...
        public PanelPersonajeCargado(JTextPane panelDeTexto, Juego juego){
        ...
        private void initUI(){
            ...
            panelSupervivienteEntero.setBorder(new EmptyBorder(10, 10, 10, 10));
            panelSupervivienteEntero.setBackground(Color.WHITE);
            ...
            // Botón seguir
            seguir = new JButton("Siguiente Ronda...");
            seguir.addActionListener(e->{
                panelDeTexto.setText(panelDeTexto.getText() + "Siguiente ronda...\n");
